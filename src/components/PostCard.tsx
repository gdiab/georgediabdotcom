    ...
    <article className="card card-clickable group animate-fade-in">
      <Link href={`/blog/${post.slug}`} className="block">
        ...
        {post.coverImage ? (
          ...
          <div className={`relative ${featured ? 'h-56' : 'h-48'} w-full bg-gray-700 flex items-center justify-center rounded-t-lg border-b border-gray-600`}>
        ...
        <div className={`p-${featured ? '8' : '6'}`}>
          ...
          <div className="flex items-center justify-between text-sm text-gray-400">
            ...
            <div className="flex items-center text-blue-400 group-hover:text-blue-300 transition-colors ml-auto">
